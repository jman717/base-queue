...
var base = require('base-queue/appenders/base.js')

exports = module.exports = class with_tagline extends base {
	constructor(props) {
		super(props)
		var t = this, fname = 'all.constructor'

		try {
			t.aname = 'with_tagline'
	...
	init(props = {}) {
		...
		try {
			...
			t.get_objects_to_process().map((dat, i) => {
				dat = { props: { id: (i + 1), log: t.parent.logMsg, tagline: t.tagline } }  
